...
const handleDeleteClick = async () => {
    let res = await Api.deleteMedic(userInfo._id)
    navigation.reset({
        routes: [{ name: 'MainTab' }]
    })
}
        ...
        <Container>
            <Scroller>
                ...
                <PageBody>
                    ...
                    <ServiceArea>
                    <ServiceName>Idade: {userInfo.idade}</ServiceName>
                    <ServiceName>Especialidade: {userInfo.especialidade}</ServiceName>
                    <ServiceName>Cidade: {userInfo.cidade} / {userInfo.uf}</ServiceName>
                    <ServiceName>Cadastrado desde: {moment(userInfo.createdAt).calendar()}</ServiceName>
                    <SignMessageButton onPress={handleDeleteClick}>
                        <SignMessageButtonTextBold>Deletar</SignMessageButtonTextBold>
                    </SignMessageButton>
                    </ServiceArea>
            ...
            <BackButton onPress={handleBackButton}>
                <Ionicons name="ios-arrow-back" size={44} color="#FFF" style={{marginLeft: 25, marginTop: 10}}/>
            </BackButton>
        </Container>
    )
}
